...
def run(cfg):
    ...
    notes=['Qwen2-7B MATH; raw pre-final-norm decoder block activations, blocks 7/14/21/28.',
           ...
           'Mean and token codebooks are distinct. Original geometry tables fit 4 positions per training question and test all 16. Interventions use a separately versioned all-16-position codebook, declared in their own plan.',
