"""Independent saved-data checks with real MATH re-scoring, no GPU decoder."""
import argparse
import json
...
def check_arrays(path, positions, cfg, model, gamma):
    ...
    # Independently evaluated bf16 RMSNorm allows one output rounding step.
    np.testing.assert_allclose(a['post'], expected, rtol=1/128, atol=.002)
